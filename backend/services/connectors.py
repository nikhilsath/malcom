...
DEFAULT_CONNECTOR_PROVIDER_METADATA: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "setup_fields": [
            {"key": "name", "label": "Integration name", "input_type": "text", "required": True},
            {"key": "host", "label": "Host", "input_type": "text", "required": True},
            {"key": "port", "label": "Port", "input_type": "text", "required": True},
            {"key": "database", "label": "Database name", "input_type": "text", "required": True},
            {"key": "username", "label": "Username", "input_type": "text", "required": True},
            {"key": "password", "label": "Password", "input_type": "password", "required": True, "secret": True},
            {"key": "sslmode", "label": "SSL mode", "input_type": "text", "required": False},
        ],
        "ui_copy": {
            "eyebrow": "Database",
            "title": "cPanel PostgreSQL setup",
            "description": "Provide host, port, database, username, and password to connect to a PostgreSQL database managed via cPanel.",
            "last_checked_empty": "cPanel PostgreSQL connection has not been checked yet.",
        },
        "action_labels": {
            "save": "Save connector",
            "test": "Check connection",
            ...
            "revoke": "Remove connector",
        },
        "status_messages": {
            "draft": "Add the database connection details to begin.",
            "pending_oauth": "cPanel PostgreSQL uses credentials; no OAuth flow is required.",
            "connected": "Connection details are valid. Use Check connection to verify before use.",
            "needs_attention": "Connection needs attention. Check the host, port, and credentials.",
            "expired": "Stored credentials may be invalid. Update the credentials to continue.",
            "revoked": "Credentials were removed. Add credentials to restore this integration.",
        },
    },
)
