"""Connector secret protection and masking helpers.

Provides XOR-stream encryption with HMAC signature for connector credential fields.
Primary identifiers: ``protect_connector_secret_value``, ``unprotect_connector_secret_value``,
``mask_connector_secret``, ``extract_connector_secret_map``.
"""
