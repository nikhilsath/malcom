...
def revoke_connector_record(record: dict[str, Any], protection_secret: str | None = None) -> tuple[dict[str, Any], str]:
    """Perform provider-specific revoke actions and update `record` status/message.

    Returns (updated_record, message).
    """
